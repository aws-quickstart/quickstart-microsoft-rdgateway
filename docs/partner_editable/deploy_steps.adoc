...
[cols=2*]
|===
^|https://fwd.aws/AdxKM[Deploy Remote Desktop Gateway into a new VPC on AWS^]
^|https://fwd.aws/JVkXY[View template^]

^|https://fwd.aws/z67Gy[Deploy a standalone Remote Desktop Gateway into an existing VPC on AWS^]
^|https://fwd.aws/KyqPn[View template^]

^|https://fwd.aws/AmVKK[Deploy a domain-joined Remote Desktop Gateway into an existing VPC on AWS^]
